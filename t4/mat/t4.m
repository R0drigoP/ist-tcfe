...
printf("op1_TAB\n")
printf("$V_O (V)$ = %.15e\n", VO1)
printf("$v_{o}/v_{i}$ = %.15e\n", AV1)
printf("$Z_{O1} (Ohm)$ = %.15e\n", ZO1)
printf("$Z_{I1} (Ohm)$ = %.15e\n", ZI1)
printf("op1_END\n")

printf("op2_TAB\n")
printf("$V_{load} (V)$ = %.15e\n", VO2)
printf("$v_{load}/v_{i2}$ = %.15e\n", AV2)
printf("$Z_{O2} (Ohm)$ = %.15e\n", ZO2)
printf("$Z_{I2} (Ohm)$ = %.15e\n", ZI2)
printf("op2_END\n")

printf("op3_TAB\n")
printf("$V_{load} (V)$ = %.15e\n", VO2)
printf("$v_{load}/v_{i}$ = %.15e\n", AV)
printf("$Z_O (Ohm)$ = %.15e\n", ZO)
printf("$Z_I (Ohm)$ = %.15e\n", ZI)
printf("op3_END\n")
